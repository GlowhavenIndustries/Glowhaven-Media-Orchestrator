...
- **Secure by default:** Credentials stay local, security headers are applied, and CSV downloads are non-cacheable.
...
- No-cache CSV responses for safer exports on shared machines.
- Playlist URL validation and consistent error handling paths.
